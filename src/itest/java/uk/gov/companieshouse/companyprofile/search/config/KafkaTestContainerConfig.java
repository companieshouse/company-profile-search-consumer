...
public class KafkaTestContainerConfig {
    ...
    public KafkaContainer kafkaContainer() {
        KafkaContainer kafkaContainer = new KafkaContainer(DockerImageName.parse("confluentinc/cp-kafka:latest")).withKraft();
    ...
    public KafkaConsumer<String, Object> invalidTopicConsumer() {
        ...
        props.put(ConsumerConfig.BOOTSTRAP_SERVERS_CONFIG, kafkaContainer().getBootstrapServers());
        props.put(ConsumerConfig.AUTO_OFFSET_RESET_CONFIG, "earliest");
        props.put(ConsumerConfig.GROUP_ID_CONFIG, "company-profile-search-consumer");
        props.put(ConsumerConfig.KEY_DESERIALIZER_CLASS_CONFIG, ErrorHandlingDeserializer.class);
        props.put(ConsumerConfig.VALUE_DESERIALIZER_CLASS_CONFIG, ErrorHandlingDeserializer.class);
        props.put(ErrorHandlingDeserializer.KEY_DESERIALIZER_CLASS, StringDeserializer.class);
        ...
        consumer.subscribe(List.of(
                "stream-company-profile-company-profile-search-consumer-invalid",
                "stream-company-profile-company-profile-search-consumer-error",
                "stream-company-profile-company-profile-search-consumer-retry"));
        return consumer;
    }
